...
var NO_CONTACTS_TEXT = 'Keine Produkte in der Einkaufsliste';
...
class Einkaufsliste {
    ...
    createContact(contact) {
        ...
        result.querySelector('.contact-name').innerText = contact.firstName;
...
window.Einkaufsliste = Einkaufsliste;
